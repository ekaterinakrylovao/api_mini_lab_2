import { updateSignUpBtnStatus } from "./main.js";
...
export const validatePassword = (password) => {
  ...
  // Проверка, что пароль содержит хотя бы один символ в верхнем регистре
  const hasUpperCase = /[A-Z]/.test(password);

  // Проверка, что пароль содержит хотя бы один символ в нижнем регистре
  const hasLowerCase = /[a-z]/.test(password);

  // Проверка, что пароль содержит хотя бы один специальный символ
